    ...
    def handle(self, *args, **options):
        for t_type in TransactionType.getTypes():
            ...
            if not T.exists():
                ...
                self.stdout.write(self.style.SUCCESS("'%s' "% transaction_type)+" Successfully created ")
                ...
                self.stdout.write(self.style.SUCCESS("'%s'"% t_type)+' Transaction Type Already exists! ')